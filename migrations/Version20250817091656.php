 ...
 */
final class Version20250817091656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', assigned_driver_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', created_by_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', customer_phone VARCHAR(20) NOT NULL, customer_name VARCHAR(120) DEFAULT NULL, address VARCHAR(255) NOT NULL, amount NUMERIC(10, 2) NOT NULL, status VARCHAR(40) NOT NULL, idempotency_key VARCHAR(64) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_F52993987FD1C147 (idempotency_key), INDEX IDX_F5299398BAE38CAB (assigned_driver_id), INDEX IDX_F5299398B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398BAE38CAB FOREIGN KEY (assigned_driver_id) REFERENCES driver_profile (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F5299398BAE38CAB');
