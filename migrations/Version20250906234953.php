 ...
 */
final class Version20250906234953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', order_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', brand VARCHAR(50) NOT NULL, capacity VARCHAR(20) NOT NULL, quantity INT NOT NULL, pickup_address VARCHAR(255) DEFAULT NULL, INDEX IDX_52EA1F098D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `orders` (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', assigned_driver_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', created_by_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', customer_phone VARCHAR(20) NOT NULL, customer_name VARCHAR(120) DEFAULT NULL, address VARCHAR(255) NOT NULL, amount NUMERIC(10, 2) NOT NULL, status VARCHAR(40) NOT NULL, idempotency_key VARCHAR(64) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, address_lat VARCHAR(32) NOT NULL, address_lon VARCHAR(32) NOT NULL, UNIQUE INDEX UNIQ_E52FFDEE7FD1C147 (idempotency_key), INDEX IDX_E52FFDEEBAE38CAB (assigned_driver_id), INDEX IDX_E52FFDEEB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
